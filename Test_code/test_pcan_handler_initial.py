...
GESTURES = {
    'rock': {
        # 주먹 쥐기
        2: [1500, -1000, 1500, 1000],     # 엄지: 안쪽으로 굽히고, z축 회전
        3: [0, 1000, 1000, 1000],     # 검지: 완전히 접기
        4: [0, 1000, 1000, 1000],     # 중지: 완전히 접기
        5: [0, 1000, 1000, 1000]      # 약지/소지: 완전히 접기
    },
    'scissors': {
    ...
    try:
        ...
        while True:
            ...
            if choice in ['1', '2', '3']:
                ...
                for can_id in range(2, 6):
                    print(f"Position input = {positions[can_id]}")
